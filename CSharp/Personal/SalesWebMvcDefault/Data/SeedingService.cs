    ...
    public class SeedingService
    {
        public static void Seed(IApplicationBuilder applicationBuider)
        {
            using (var serviceScope = applicationBuider.ApplicationServices.CreateScope())
            {
                ...
                Seller s1 = new(1, "Bob Brown", "bob.brown@gmail.com", new DateTime(1985, 1, 20), 1850.00, d1);
                Seller s2 = new(2, "Maria Green", "maria.green@gmail.com", new DateTime(1979, 12, 31), 3500.00, d2);
                Seller s3 = new(3, "Alex Grey", "alex.grey@gmail.com", new DateTime(1988, 7, 15), 2200.00, d1);
                Seller s4 = new(4, "Martha Red", "martha.red@gmail.com", new DateTime(1993, 11, 30), 3000.00, d4);
                Seller s5 = new(5, "Donald Blue", "donald.blue@gmail.com", new DateTime(2000, 1, 9), 4000.00, d3);
                Seller s6 = new(6, "Alex Pink", "alex.pink@gmail.com", new DateTime(1987, 3, 4), 3120.00, d2);
